...
Output ONLY the final ad script. No reasoning, no thinking, no meta-commentary. Start your response immediately with the answer.

Format: clean markdown with timing markers like [0:00-0:03].`;
